...
class RightPicturesTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        picturesImgViews[0].frame = CGRect(x: paddingWidth, y: paddingWidth, width: cellSmallWidth, height: cellSmallWidth)
        picturesImgViews[1].frame = CGRect(x: paddingWidth, y: cellWidthThird+paddingWidth, width: cellSmallWidth, height: cellSmallWidth)
        picturesImgViews[2].frame = CGRect(x: cellWidthThird+paddingWidth, y: paddingWidth, width: cellBigWidth, height: cellBigWidth)
